...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('item_pedidos', function (Blueprint $table) {
            ...
            $table->boolean('finalizado_pdv')->default(0);

            // alter table item_pedidos add column tempo_preparo integer default null;
            // alter table item_pedidos add column ponto_carne varchar(30) default null;
