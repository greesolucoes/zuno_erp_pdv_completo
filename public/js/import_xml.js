...
$(document).on("click", ".btn-modal-altera", function () {
    ...
    $('#modal_altera_produto #modal_valor_atacado').val(($inpValorAtacado.val()))

    $('#modal_altera_produto #modal_quantidade_atacado').val($inpQtdAtacado.val())
    $('#modal_altera_produto #modal_valor_minimo_venda').val(($inpValorMinimoVenda.val()))
...
$(document).on("click", ".btn-modal-alterar", function () {
    ...
    $('.line_'+KEY).find('._valor_atacado').val(valor_atacado)
