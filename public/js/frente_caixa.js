...
function calcTotal() {
    ...
    setTimeout(() => {
        total_venda = total;
        $(".total-venda").html(convertFloatToMoeda(total + parseFloat(VALORACRESCIMO) + parseFloat(VALORFRETE) - parseFloat(DESCONTO)));
        $('#inp-valor_total').val(convertFloatToMoeda(total + parseFloat(VALORACRESCIMO) + parseFloat(VALORFRETE) - parseFloat(DESCONTO)));
        $(".total-venda-modal").html("R$ " + convertFloatToMoeda(total + VALORACRESCIMO + VALORFRETE - DESCONTO));
