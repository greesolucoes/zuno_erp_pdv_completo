...
class SalasAtendimentoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return response()->json([
            'data' => $data->getCollection()->map(fn (SalaAtendimento $s) => [
                'id' => (string) $s->id,
                'nome' => (string) $s->nome,
    ...
    public function show(string $id)
    {
        ...
        $s = SalaAtendimento::query()->where('empresa_id', $empresaId)->findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        $tipos = ['consultorio', 'triagem', 'vacinacao', 'emergencia', 'laboratorio', 'outro'];
        ...
        $s = SalaAtendimento::create(array_merge($validated, [
