            ...
            $nfe = DB::transaction(function () use ($request) {
                ...
                for ($i = 0; $i < sizeof($request->produto_id); $i++) {
                    ...
                    if ($request->produto_id[$i] == 0) {
                        ...
                        $product->valor_minimo_venda = __convert_value_bd($request->_valor_minimo_venda[$i]);
                        ...
                        $product->valor_atacado = __convert_value_bd($request->_valor_atacado[$i]);
...
private function cadastrarProduto($request, $i, $local_id)
{
    ...
    $p = Produto::create([
        ...
        'valor_minimo_venda' => __convert_value_bd($request->_valor_minimo_venda[$i]),

        'valor_atacado' => __convert_value_bd($request->_valor_atacado[$i]),
