            ...
            <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mt-3 g-2">
                        ...
                        <div class="col-md-2">
                            {!!Form::select('filtro_data', 'Filtro de data', ['data_vencimento' => 'Data de vencimento', 'data_recebimento' => 'Data de recebimento'])
                        ...
                        <table class="table table-striped table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endcan
                                    <td><label style="width: 400px;">{{ ($item->cliente) ? $item->cliente->razao_social : '--' }}</label></td>
                                    ...
                                    <td>
                                        <form action="{{ route('conta-receber.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" style="width: 200px;">
                                            ...
                                            <a title="Ver conta" class="btn btn-light btn-sm" target="_blank" href="{{ route('conta-receber.show', [$item->id]) }}">
