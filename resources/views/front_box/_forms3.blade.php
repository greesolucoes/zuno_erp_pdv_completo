        ...
        <div class="col-lg-5 grid1">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <select class="form-control select2" name="produto_id" id="produto_id">
                        ...
                        <option data-valor="{{ $p->valor_unitario }}" value="{{ $p->id }}">#{{ $p->numero_sequencial }} {{ $p->nome }} [R${{ __moeda($p->valor_unitario) }}]</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-12 col-lg-6 totalizador mt-1 totalizador-desconto" onclick="openModalAcrescimo()">
                    Acréscimo <strong class="acrescimo">R$ 0,00</strong>
                </div>
                <div class="col-12 col-lg-6 totalizador mt-1 totalizador-desconto" onclick="openModalDesconto()">
                    Desconto <strong class="desconto">R$ 0,00</strong>
                </div>
                ...
                <div class="col-6 col-lg-3 col-sm-3 col-xl-2 col-md-4 prod p-1 card-prod-{{ $p->id }}" onclick="adicionarItemCard('{{ $p->id }}')">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between" style="height: 70px;">
                            <h5>{{ $p->nome.substr(0, 35) }} {{ strlen($p->referencia_balanca) > 0 && $p->referencia_balanca > 0 ? "REF".$p->referencia_balanca : '' }}</h5>

                            <h6 class="footer-text valor-produto text-primary">R$ {{ __moeda($p->valor_unitario) }}</h6>
                        </div>
                    </div>
                </div>
                @endforeach
