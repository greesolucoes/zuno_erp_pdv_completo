        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    !!}
                    <div class="col-md-12">
                        <h5>Valor de abertura: <strong class="text-primary">R$ {{ __moeda($valor_abertura) }}</strong></h5>
                        <h5>Total em sangrias: <strong class="text-muted">R$ {{ __moeda($somaSangria) }}</strong></h5>
                        <h5>Total em suprimentos: <strong class="text-muted">R$ {{ __moeda($somaSuprimento) }}</strong></h5>
                        <h4>Saldo: <strong class="text-success">R$ {{ __moeda($totalVendas + $valor_abertura - $somaSangria + $somaSuprimento) }}</strong></h4>
                    </div>
                    ...
                    <div class="col-md-12 mt-3">
                        {!! Form::tel('valor_dinheiro', 'Valor em Dinheiro')->attrs(['class' => 'moeda']) !!}
                    </div>
                    <div class="col-md-12 mt-3">
                        {!! Form::tel('valor_cheque', 'Valor em Cheque')->attrs(['class' => 'moeda']) !!}
                    </div>
                    <div class="col-md-12 mt-3">
                        {!! Form::tel('valor_outros', 'Valor Outros')->attrs(['class' => 'moeda']) !!}
                    </div>
                    <div class="col-md-12 mt-3">
