    ...
    <div class="card">
        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
            ...
            <div class="d-flex flex-wrap gap-2 new-colors">
                <a
                    href="{{ route('vet.assessment-models.index', ['page' => request()->query('page', 1)]) }}"
                ...
                <a
                    href="{{ route('vet.assessment-models.edit', ['modeloAvaliacao' => $modelo->id, 'page' => request()->query('page', 1)]) }}"
