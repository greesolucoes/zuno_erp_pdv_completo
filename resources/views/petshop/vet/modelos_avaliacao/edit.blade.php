@extends('layouts.app', ['title' => 'Editar Modelo de Avaliação'])
            ...
            {!! Form::open()
                ...
                <div class="pl-lg-4">
                    ...
                    <div class="mt-4 d-flex justify-content-end new-colors gap-2">
                        <a href="{{ route('vet.assessment-models.show', ['modeloAvaliacao' => $modelo->id, 'page' => request()->query('page', 1)]) }}" class="btn btn-secondary px-4">
                            Cancelar
                        </a>
...
@section('js')
    <script>
        ...
        window.assessmentModelExistingFields = @json($modelo->fields);
    </script>
