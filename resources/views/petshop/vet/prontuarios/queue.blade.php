    ...
    <div class="container-fluid vet-queue py-3">
        <div class="row g-3 align-items-center mb-2">
            <div class="col-12 col-lg">
                <h1 class="vet-queue__title mb-1">Fila de Consultas</h1>
                <p class="vet-queue__subtitle mb-0">
                    Visão em tempo real da jornada de atendimentos desta {{ $dateLabel }}.
                </p>
            </div>
        ...
        <div class="tab-content mt-3" id="vet-queue-tab-content">
                ...
                @php
                    $columns = [
                        'in_progress' => [
                            ...
                            'variant' => 'info',
                            'empty' => 'Nenhum paciente está em atendimento agora.',
                        ],
                        'waiting' => [
                            'title' => 'Em espera',
                            'subtitle' => 'Prontos para serem chamados',
                            'variant' => 'warning',
                            'empty' => 'Nenhum paciente aguardando neste momento.',
                        ],
                        'upcoming' => [
                            'title' => 'Próximos horários',
                            'subtitle' => 'Agendados para hoje',
                            'variant' => 'primary',
                            'empty' => 'Todos os horários de hoje já foram iniciados.',
                        ],
                    ];
                @endphp
                                    ...
                                    <div class="vet-queue__column-body">
                                        @forelse ($columnItems as $item)
                                            @php
                                                ...
                                                $isEmergency = !empty($item['priority']) && Str::contains(Str::lower($item['priority']), 'emerg');
                                            ...
                                            <article class="vet-queue__card{{ !empty($item['is_delayed']) ? ' vet-queue__card--delayed' : '' }}">
                                                        ...
                                                        <div class="d-flex align-items-start justify-content-between gap-2">
                                                            <div>
                                                                ...
                                                                <div class="vet-queue__card-subtitle">
                                                                    {{ $item['patient']['species'] }} • {{ $item['service'] }}
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="vet-queue__chips mt-2">
                                                            ...
                                                            @if ($elapsedMinutes)
                                                                <span class="vet-queue__chip vet-queue__chip--success">
                                                                    ...
                                                                    Em consulta há {{ $formatMinutes($elapsedMinutes) }}
                                                                </span>
                                                            @endif
                                                ...
                                                <div class="vet-queue__card-footer">
                                                    ...
                                                    <div class="vet-queue__footer-right">
                                                        @if (!empty($item['tutor']))
                                                        ...
                                                        @endif
                                                        <div class="vet-queue__actions">
                                                            <a href="{{ route('vet.atendimentos.edit', $item['id']) }}"
                                                                class="btn btn-outline-primary btn-sm">
                                                                <i class="ri-eye-line"></i>
                                                                Ver atendimento
                                                            </a>
                                                            @if (!empty($item['record']))
                                                                <a href="{{ route('vet.records.edit', $item['record']['id']) }}"
                                                                    class="btn btn-outline-success btn-sm">
                                                                    <i class="ri-file-search-line"></i>
                                                                    Ver Consulta
                                                                </a>
                                                            @else
                                                                <a href="{{ route('vet.records.create', ['attendance' => $item['id']]) }}"
            ...
            <div class="col-12 col-xxl-4 d-flex flex-column gap-3">
                <div class="vet-queue__sidebar-card">
                    ...
                    @if ($current)
                        <div class="vet-queue__highlight vet-queue__highlight--info">
                            <strong><i class="ri-stethoscope-line me-1"></i> Em atendimento agora</strong>
                            <div>{{ $current['patient']['name'] }} com {{ $current['veterinarian']['name'] }}</div>
                            <small>Iniciado há {{ $formatMinutes($current['elapsed_minutes'] ?? 0) }}</small>
                        </div>
                    @endif

                    @if ($next)
                        <div class="vet-queue__highlight vet-queue__highlight--success">
                            <strong><i class="ri-roadster-fill me-1"></i> Próximo da fila</strong>
                    ...
                    @if (! $current && ! $next && ! $delayed && ! $priority)
                        <div class="vet-queue__highlight vet-queue__highlight--info">
                            <strong>Fila estável</strong>
                            <small>Nenhum alerta crítico neste momento.</small>
                        </div>
                    @endif
                </div>
                ...
                @if (!empty($veterinarianBoards))
                    <div class="vet-queue__sidebar-card">
                        <div class="vet-queue__sidebar-title">Capacidade por médico</div>
                                ...
                                <div class="vet-queue__doctor-card">
                                    <div class="vet-queue__doctor-summary">
                                        ...
                                        <div>
                                            ...
                                            <div class="vet-queue__doctor-stats">
                                                ...
                                                <span><i class="ri-stethoscope-line"></i> {{ $board['in_progress'] }} em atendimento</span>
                                    ...
                                    @if (!empty($board['active']))
                                        <div class="vet-queue__doctor-active">
                                            ...
                                            {{ $board['active']['patient']['name'] }} em atendimento
                                        </div>
                                    @endif
                ...
                <div class="vet-calendar mt-2">
                    <div class="vet-calendar__hero">
                        <div class="vet-calendar__hero-date">
                            <span class="vet-calendar__hero-label">Agenda do dia</span>
                        ...
                        <div class="vet-calendar__hero-stats">
                            <div class="vet-calendar__hero-stat">
                                ...
                                <span class="vet-calendar__hero-stat-label">Atendimentos com horário</span>
                            </div>
                            <div class="vet-calendar__hero-stat">
                                <span class="vet-calendar__hero-stat-value">{{ $calendarView['summary']['in_progress'] }}</span>
                                <span class="vet-calendar__hero-stat-label">Em andamento agora</span>
                            </div>
                            <div class="vet-calendar__hero-stat">
                                ...
                                <span class="vet-calendar__hero-stat-label">@if ($calendarView['summary']['peak_hour'])Pico com {{ $calendarView['summary']['peak_count'] }} atendimentos @else Agenda equilibrada @endif</span>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <article class="vet-calendar__event-card vet-calendar__event-card--{{ $event['status_color'] ?? 'primary' }}{{ !empty($event['is_delayed']) ? ' is-delayed' : '' }}">
                                                ...
                                                <div class="vet-calendar__event-body">
                                                    ...
                                                    @if (!empty($event['service']))
                                                        <div class="vet-calendar__event-service"><i class="ri-stethoscope-line me-1"></i>{{ $event['service'] }}</div>
                                                    @endif
                    ...
                    @else
                        <div class="vet-calendar__empty">
                            ...
                            @if ($calendarView['summary']['unscheduled'] > 0)
                                <span class="d-block mt-2">Ainda há {{ $calendarView['summary']['unscheduled'] }} atendimentos aguardando definição.</span>
                            @endif
                        </div>
                    @endif
                                ...
                                @foreach ($calendarView['unscheduled'] as $event)
                                    <div class="vet-calendar__unscheduled-card">
                                        ...
                                        <div class="vet-calendar__unscheduled-meta">
                                            @if (!empty($event['service']))
                                                <span><i class="ri-stethoscope-line me-1"></i>{{ $event['service'] }}</span>
                                            @endif
                                            @if (!empty($event['veterinarian']))
                                                <span><i class="ri-user-heart-line me-1"></i>{{ $event['veterinarian'] }}</span>
                                            @endif
