                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 mt-1">
                                <button class="btn btn-success w-100" onclick="login('contato@amberweb.site', 'amber1200')">
                                    SUPERADMIN
                                </button>
                            </div>
                            <div class="col-12 col-lg-6 mt-1">
                                <button class="btn btn-dark w-100" onclick="login('jeffersongam51@gmail.com', '123456')">
                                    EMPRESA TESTE
                                </button>
                            </div>
                        </div>
                        <br>
                        <a href="https://wa.me/5551995228815">WhatsApp <strong>51995228815</strong></a>
                    </div>
                    @endif
