<tr>
    <td>
        <form class="d-flex align-items-center gap-1" action="{{ route('vet.salas-internacao.destroy', $item->id) }}" method="post" id="form-{{ $item->id }}">
            @method('delete')
            @csrf
            ...
            <a
                ...
                title="Editar Sala"
                href="{{ route('vet.salas-internacao.edit', [$item->id, 'page' => request()->query('page', 1)]) }}">
                <img
                    height="26"
                    width="26"
