    ...
    <td>
        <div class="d-inline-flex gap-2">
            <a 
                ...
                href="{{ route('vet.assessment-models.show', ['modeloAvaliacao' => $item['id'], 'page' => request()->query('page', 1)]) }}"
            >
                <img
                    height="26"
                    width="26"
            ...
            <a
                href="{{ route('vet.assessment-models.edit', ['modeloAvaliacao' => $item['id'], 'page' => request()->query('page', 1)]) }}"
                class="border-0 m-0 p-0 bg-transparent text-color-back"
                title="Editar modelo"
            >
                <img
