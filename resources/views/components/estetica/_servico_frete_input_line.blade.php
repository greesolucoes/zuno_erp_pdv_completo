<table class="table table-dynamic table-estetica-servico-frete">
    <thead>
        <tr>
            <th width="60%">
    ...
    <tbody>
        @isset($frete)
            <tr class="dynamic-form">
                ...
                <td>
                    <input 
                        value="{{ __moeda($frete->subtotal) ?? 0 }}" 
    ...
    <tfoot>
        <tr>
            <td colspan="3" class="text-right">
                ...
                >
                    ...
                    @if (!isset($data->esteticaClienteEndereco))
        ...
        <input 
            ...
            id="endereco_cliente" 
            value="{{ isset($data->esteticaClienteEndereco) ? $data->esteticaClienteEndereco : null}}"
        />
    </tfoot>
</table>