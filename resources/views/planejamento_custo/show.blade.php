		...
		<div class="card text-center">
			...
			<div class="card-body">
				...
				<div class="text-start mt-3">
					...
					<p class="text-muted mb-2"><strong>Cliente:</strong> <span class="ms-2">{{ $item->cliente->razao_social }}</span></p>
					<p class="text-muted mb-2"><strong>CPF/CNPJ:</strong> <span class="ms-2">{{ $item->cliente->cpf_cnpj }}</span></p>
					<p class="text-muted mb-2"><strong>Telefone:</strong> <span class="ms-2">{{ $item->cliente->telefone }}</span></p>
					<p class="text-muted mb-2"><strong>Email:</strong> <span class="ms-2">{{ $item->cliente->email }}</span></p>
					<p class="text-muted mb-2"><strong>Cidade:</strong> <span class="ms-2">{{ $item->cliente->cidade ? $item->cliente->cidade->info : '--' }}</span></p>
					{!! $item->_estado() !!}
