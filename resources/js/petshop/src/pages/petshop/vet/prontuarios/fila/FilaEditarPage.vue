...
import { getFilaProntuarioById, loadFilaProntuariosOptions, updateFilaProntuario, type FilaProntuarioLoadOptions } from '../../../../../services/petshop/vet/prontuarios/fila.service'
...
async function onSave(payload: FilaProntuarioUpsertPayload) {
  await updateFilaProntuario(id, payload)
...
<template>
  ...
  <FilaFormWizard v-else-if="options" mode="edit" :model-value="draft" :load-options="options" :on-save="onSave" :on-cancel="onCancel" />
</template>
