...
import { getVacinaById, loadVacinasOptions, type Vacina, type VacinasLoadOptions, updateVacina } from '../../../../../services/petshop/vet/cadastros/vacinas.service'
...
async function onSave(payload: VacinaUpsertPayload) {
  await updateVacina(vacinaId, payload)
