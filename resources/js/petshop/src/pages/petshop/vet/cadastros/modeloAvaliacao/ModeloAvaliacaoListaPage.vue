...
import { listModelosAvaliacao, loadModeloAvaliacaoOptions, type ModeloAvaliacaoLoadOptions } from '../../../../../services/petshop/vet/cadastros/modeloAvaliacao.service'
...
const allRows = computed<Row[]>(() => {
  ...
  const modelos = listModelosAvaliacao(busca.value)
...
onMounted(() => {
  loadModeloAvaliacaoOptions().then((o) => {
    options.value = o
  })
