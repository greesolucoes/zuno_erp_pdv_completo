...
import { createModeloAtendimentoDraft, type ModeloAtendimentoDraft } from '../../../../../composables/createModeloAtendimentoDraft'
import { getModeloAtendimentoById, loadModeloAtendimentoOptions, type ModeloAtendimento, type ModeloAtendimentoLoadOptions } from '../../../../../services/petshop/vet/cadastros/modeloAtendimento.service'
...
<template>
  ...
  <ModeloAtendimentoFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
