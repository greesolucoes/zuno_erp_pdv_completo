...
import { createModeloAvaliacaoDraft, type ModeloAvaliacaoDraft, type ModeloAvaliacaoUpsertPayload } from '../../../../../composables/createModeloAvaliacaoDraft'
import {
  getModeloAvaliacaoById,
  loadModeloAvaliacaoOptions,
  type ModeloAvaliacao,
  type ModeloAvaliacaoLoadOptions,
  updateModeloAvaliacao,
} from '../../../../../services/petshop/vet/cadastros/modeloAvaliacao.service'
...
async function onSave(payload: ModeloAvaliacaoUpsertPayload) {
  await updateModeloAvaliacao(modelId, payload)
