...
import { createSalaAtendimentoDraft, type SalaAtendimentoDraft } from '../../../../../composables/createSalaAtendimentoDraft'
import { getSalaAtendimentoById, loadSalasAtendimentoOptions, type SalaAtendimento, type SalasAtendimentoLoadOptions } from '../../../../../services/petshop/vet/cadastros/salasAtendimento.service'
...
<template>
  ...
  <SalaAtendimentoFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
