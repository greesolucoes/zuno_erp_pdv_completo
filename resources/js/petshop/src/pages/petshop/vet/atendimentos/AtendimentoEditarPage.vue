...
import { getAtendimentoById, loadAtendimentosOptions, type Atendimento, type AtendimentoLoadOptions, updateAtendimento } from '../../../../services/petshop/vet/atendimentos/atendimentos.service'
...
async function onSave(payload: AtendimentoUpsertPayload) {
  await updateAtendimento(atendimentoId, payload)
