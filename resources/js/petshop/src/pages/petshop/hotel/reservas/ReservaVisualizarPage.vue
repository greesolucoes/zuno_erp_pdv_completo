...
import { createReservaHotelDraft, type ReservaHotelDraft } from '../../../../composables/createReservaHotelDraft'
import { getReservaHotelById, loadReservasHotelOptions, type ReservaHotel, type ReservasHotelLoadOptions } from '../../../../services/petshop/hotel/reservas.service'
...
<template>
  ...
  <ReservaFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
