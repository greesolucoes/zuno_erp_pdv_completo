...
import type { CategoriaProdutoDraft } from '../../../composables/createCategoriaProdutoDraft'
import { createCategoriaProdutoDraft } from '../../../composables/createCategoriaProdutoDraft'
import { getCategoriaProdutoById, loadCategoriasProdutoOptions, type CategoriasProdutoLoadOptions } from '../../../services/produtos/categoriasProduto.service'
...
<template>
  ...
  <CategoriaProdutoForm v-else mode="view" :model-value="model" :load-options="options" :on-cancel="onCancel" />
</template>
