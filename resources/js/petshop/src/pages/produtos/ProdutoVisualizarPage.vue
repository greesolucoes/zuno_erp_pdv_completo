...
import { createProdutoDraft, type ProdutoDraft } from '../../composables/createProdutoDraft'
import { getProdutoById, loadProdutosOptions, type Produto, type ProdutosLoadOptions } from '../../services/produtos/produtos.service'
...
<template>
  ...
  <ProdutoFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
