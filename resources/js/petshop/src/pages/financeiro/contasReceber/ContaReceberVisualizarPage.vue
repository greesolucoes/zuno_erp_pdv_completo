...
import { getContaReceberById, loadContasReceberOptions, type ContasReceberOptions } from '../../../services/financeiro/contasReceber.service'
...
<template>
  ...
  <ContaReceberFormWizard v-else mode="view" :model-value="model" :load-options="options" :on-cancel="onCancel" />
</template>
