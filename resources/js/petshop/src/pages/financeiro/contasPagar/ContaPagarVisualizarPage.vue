...
import { getContaPagarById, loadContasPagarOptions, type ContasPagarOptions } from '../../../services/financeiro/contasPagar.service'
...
<template>
  ...
  <ContaPagarFormWizard v-else mode="view" :model-value="model" :load-options="options" :on-cancel="onCancel" />
</template>
