...
import { createModeloPrescricaoDraft, type ModeloPrescricaoDraft } from '../../../../../composables/createModeloPrescricaoDraft'
import { getModeloPrescricaoById, loadModeloPrescricaoOptions, type ModeloPrescricao, type ModeloPrescricaoLoadOptions } from '../../../../../services/petshop/vet/cadastros/modeloPrescricao.service'
...
<template>
  ...
  <ModeloPrescricaoFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
