...
import { createMedicoDraft, type MedicoDraft } from '../../../../../composables/createMedicoDraft'
import { getMedicoById, loadMedicosOptions, type Medico, type MedicosLoadOptions } from '../../../../../services/petshop/vet/cadastros/medicos.service'
...
<template>
  ...
  <MedicoFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
