...
import { createSalaInternacaoDraft, type SalaInternacaoDraft } from '../../../../../composables/createSalaInternacaoDraft'
import { getSalaInternacaoById, loadSalasInternacaoOptions, type SalaInternacao, type SalasInternacaoLoadOptions } from '../../../../../services/petshop/vet/cadastros/salasInternacao.service'
...
<template>
  ...
  <SalaInternacaoFormWizard v-else-if="options" mode="view" :model-value="draft" :load-options="options" :on-cancel="onCancel" />
</template>
