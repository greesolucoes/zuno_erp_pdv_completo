...
import { createReservaCrecheDraft, type ReservaCrecheDraft, type ReservaCrecheUpsertPayload } from '../../../../composables/createReservaCrecheDraft'
import {
...
async function onSave(payload: ReservaCrecheUpsertPayload) {
  await updateReservaCreche(reservaId, payload)
