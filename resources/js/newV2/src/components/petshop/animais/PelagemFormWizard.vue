...
const props = defineProps<{
  mode: Mode
  modelValue: PelagemDraft
  onSave?: (payload: PelagemUpsertPayload) => void | Promise<void>
  onCancel?: () => void
}>()

const isReadOnly = computed(() => props.mode === 'view')

const { draft, reset, toPayload } = createPelagemDraft(props.modelValue)
          ...
          <div class="col-md-12">
            <div class="form-group form-group-lg">
              <label class="control-label">
                <span>Nome da pelagem<span class="asterisco">*</span></span>
              </label>
              <input
                v-model="draft.nome"
                class="form-control"
                name="nome"
                placeholder="Digite o nome da pelagem"
                :readonly="isReadOnly"
                required
                type="text"
              />
