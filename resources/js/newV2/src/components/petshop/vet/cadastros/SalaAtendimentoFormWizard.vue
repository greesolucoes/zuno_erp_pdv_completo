...
import type { SalasAtendimentoLoadOptions } from '../../../../services/petshop/vet/cadastros/salasAtendimento.service'

type Mode = 'create' | 'edit' | 'view'

const props = defineProps<{
  mode: Mode
  modelValue: SalaAtendimentoDraft
  loadOptions: SalasAtendimentoLoadOptions
  onSave?: (payload: SalaAtendimentoUpsertPayload) => void | Promise<void>
  onCancel?: () => void
}>()

const isReadOnly = computed(() => props.mode === 'view')

const { draft, reset, toPayload } = createSalaAtendimentoDraft(props.modelValue)
    ...
    <div class="pnlCollapse semi-aberto">
      ...
      <div style="padding: 0 20px">
        <div class="row" style="margin-top: 5px; margin-bottom: 0">
          <div class="col-md-12">
            <div class="form-group form-group-lg">
              <label class="control-label"><span>Capacidade</span></label>
